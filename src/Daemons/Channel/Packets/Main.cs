...
namespace Minerva
{
    partial class PacketProtocol
    {
        ...
        public static void Initialise(Dictionary<ushort, PacketInfo> methods, Dictionary<string, PacketConstructor> constructors)
        {
            ...
            methods[0x087D] = new PacketInfo("Unknown87D", Unknown87D);
            ...
            methods[0x0194] = new PacketInfo("Unknown191", Unknown194);
            methods[0x08C8] = new PacketInfo("Unknown8C8", Unknown8C8);
            methods[0x09C8] = new PacketInfo("Unknown9C8", Unknown9C8);
            methods[0x09D6] = new PacketInfo("Unknown9D6", Unknown9D6);
            ...
            methods[0x09C8] = new PacketInfo("Unknown9C8", Unknown9C8);
            methods[0x09C8] = new PacketInfo("Unknown194", Unknown194);
            methods[0x09C8] = new PacketInfo("Unknown193", Unknown193);
            methods[0x09C8] = new PacketInfo("Unknown191", Unknown191);
            ...
            methods[0x086C] = new PacketInfo("Unknown_86C", Unknown_86C);
            methods[0x09FE] = new PacketInfo("Unknown9FE", Heartbeat);
