            ...
            /*foreach (var c in clients.Values)
            {
                foreach (var m in Mobs)
                {
                    ...
                    if (!m.IsMoving)
                    {
                        ...
                        //foreach (var c in clients.Values)
                        //{
                            var beginMove = c.CreatePacket("MobsMoveBgn", m);
                            c.Send(beginMove, "MobsMoveBgn");
                        //}
                    }
                    ...
                    if (!UpdatePosition(m))
                    {
                        //foreach (var c in clients.Values)
                        //{
                            var beginEnd = c.CreatePacket("MobsMoveEnd", m);
                            c.Send(beginEnd, "MobsMoveEnd");
                        //}
                    }
                }
            }*/
        ...
        public void UpdateMonsterMovement(ClientHandler c)
        {
            foreach (var m in Mobs)
            {
                ...
                if (!UpdatePosition(m))
                {
                    ...
                    //{
                    var beginEnd = c.CreatePacket("MobsMoveEnd", m);
                    //c.Send(beginEnd, "MobsMoveEnd", true);
                    //}
                }
            }
        }
